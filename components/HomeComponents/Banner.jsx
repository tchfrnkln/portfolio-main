                ...
                <div className="bg-LightGray/10 w-[95%] h-[90%] px-4 py-2 rounded-xl overflow-hidden flex md:block">
                    <div className="flex items-center md:items-center md:justify-around">
                        <div className="">
                            ...
                            <a href='/contact' className='button w-max cursor-pointer'>Mail Me</a>
                            {/* <Link to='reviews' spy={true} smooth={true} duration={500} offset={-50} className="button">See Reviews</Link> */}
                        </div>
                        <div className="w-48 h-52 relative hidden md:block">
                            <Image className='absolute top-8 w-full h-full' width={300} height={300} src="/images/emoji.png" alt="emoji" />
                        </div>
                    </div>
                </div>
